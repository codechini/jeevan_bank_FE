...
const Home = () => {
  ...
  return (
    <>
      ...
      <div className="relative h-dvh overflow-hidden bg-[url(./assets/blob-haikei2.svg)] bg-cover bg-center">
        <div className="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-48">
          <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
            <div className="sm:max-w-lg">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                Banking Evolved. Your Future Secured.
              </h1>
              <p className="mt-4 text-xl text-gray-750">
                Experience effortless banking with our top-rated app. Manage finances, pay bills, and invest smarter, all from your device.
              </p>
            </div>
            <div>
              <div className="mt-10">
                ...
                <a
                  href="/openaccount"
                  className="inline-block rounded-md border border-transparent bg-purple-800 px-8 py-3 text-center font-medium text-white hover:bg-purple-900"
                >
                  Open an Account
                </a>
              </div>
