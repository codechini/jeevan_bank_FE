...
const WithdwawMoney = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:8080/api/user/accounts/${selectedAccount}/withdraw`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-6">
      <h1 className="text-4xl font-bold mb-8 text-gray-800">Withdraw Money</h1>
      <form
      ...
      >
        ...
        <div className="mb-6">
          ...
          <input
            ...
            id="description"
            type="text"
            placeholder="Enter description (e.g., ATM withdrawal)"
            value={description}
