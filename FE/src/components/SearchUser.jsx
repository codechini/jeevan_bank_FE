...
const SearchUser = () => {
  ...
  return (
    <div className="w-full max-w-4xl p-8 mx-auto bg-white rounded-lg shadow-md">
      <h2 className="mb-6 text-2xl font-bold text-center text-purple-800">Search User by ID</h2>
      ...
      {userData && (
        <div className="mt-6">
          <h3 className="mb-4 text-xl font-bold text-center text-purple-800">User Details</h3>
